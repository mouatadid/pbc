...
# %%
""" 
Probabilistic Bias Correction (PBC) for ECMWF dynamical model

For each gridpoint and target date, regress onto the specified ensemble members' forecasts 

Example usage:
  python src/models/pbc_ecmwf/batch_predict.py era5-f1_pr 19 -t std_test -y all -m None -e True
  python src/models/pbc_ecmwf/batch_predict.py era5-F5_pr 19 -t std_test -y all -m None -e True
...
from models.pbc_ecmwf.attributes import get_submodel_name
