...
MODEL_NAME = "tuned_aifspp"
SELECTED_SUBMODEL_PARAMS_FILE=resource_filename("models",
                                                os.path.join(MODEL_NAME,"selected_submodel.json"))
...
def get_submodel_name(num_years=3, margin_in_days=None):
