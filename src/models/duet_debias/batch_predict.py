""" 
Duet Debias: For each gridpoint and target date, output an equal average of pbc_debias and pbc_msn.

Example usage:
  python src/models/duet_debias/batch_predict.py era5-f1_pr 19 -t std_test
