...
# %%
""" 
Probabilistic Bias Correction (PBC) for Debiased AIFS AI model

For each gridpoint and target date, regress onto the specified ensemble members' forecasts 

Example usage:
  python src/models/pbc_debias_aifs/batch_predict.py era5-f1_pr 19 -t std_aifs_forecast -y all -m None -e True
...
from models.pbc_debias_aifs.attributes import get_submodel_name
