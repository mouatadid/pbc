...
# %%
""" 
Probabilistic Bias Correction (PBC) for MSN dynamical model

For each gridpoint and target date, regress onto the specified ensemble members' forecasts 

Example usage:
  python src/models/pbc_msn/batch_predict.py era5-f1_tas 19 -t std_test -y all -m None
...
from models.pbc_msn.attributes import get_submodel_name
